...
namespace Form1
{
    public class ITextExistencias : PdfPageEventHelper
    {
         ...
         //   table.AddCell(header);
          ...
          //  tablaCte.AddCell(cte2);
            ...
            */
            ...
            PdfPCell item = new PdfPCell(new Phrase("CATALOGO", arial2));
            ...
            PdfPCell Catalogo = new PdfPCell(new Phrase("DESCRIPCION", arial2));
            ...
            PdfPCell Descrip = new PdfPCell(new Phrase("MARCA", arial2));
            ...
            PdfPCell Cantidad = new PdfPCell(new Phrase("STOCK", arial2));
            ...
            PdfPCell coordenada = new PdfPCell(new Phrase("UBICACION", arial2));
            coordenada.HorizontalAlignment = 1;
            coordenada.VerticalAlignment = Element.ALIGN_MIDDLE;
            coordenada.BackgroundColor = BaseColor.LIGHT_GRAY;
            NombreColumnas.AddCell(coordenada);

         

            NombreColumnas.WriteSelectedRows(0, -1, 51, document.PageSize.Height - 80, writer.DirectContent);
